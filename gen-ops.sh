...
func (f ${OPNAME}${TYPENAME^}) match(wireType wireType, pb []byte) error {
...
func (f ${TYPENAME}In) match(wireType wireType, pb []byte) error {
	v, err := decode${TYPENAME^}(wireType, pb)
	if err != nil {
		return err
	}
...
func (f extract${TYPENAME^}) match(wireType wireType, pb []byte) error {
	v, err := decode${TYPENAME^}(wireType, pb)
	if err != nil {
		return err
	}
